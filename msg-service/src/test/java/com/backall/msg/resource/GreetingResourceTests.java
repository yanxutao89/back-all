...
public class GreetingResourceTests {
    ...
    public void getGreeting() throws Exception {
            ...
            public void afterConnected(final StompSession session, StompHeaders connectedHeaders) {
                session.subscribe("/topic/greetings", new StompFrameHandler() {
                    ...
                    public void handleFrame(StompHeaders headers, Object payload) {
                        GreetingMessage greeting = (GreetingMessage) payload;
                        try {
                ...
                try {
                    session.send("/msg/hello", new HelloMessage("Spring"));
                } catch (Throwable t) {
                    failure.set(t);
                    latch.countDown();
                }
        ...
        this.stompClient.connectAsync("ws://localhost:{port}/msg-websocket", this.headers, handler, this.port);
